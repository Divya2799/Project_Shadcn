    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 ">
        <div className=" p-5 flex justify-center items-start gap-10 flex-col content space-y-5">
          <h1 className=' flex w-2xl text-4xl md:text-5xl lg:text-6xl text-purple-900 font-extrabold font-sans  '>Make Your Business  Successful</h1>
        ...
        <div className="img">
          <img src="https://img.freepik.com/premium-vector/designers-agency-flat-design-concept-illustration-people-characters_9209-5399.jpg?uid=R185271760&ga=GA1.1.2114736879.1740217972&semt=ais_hybrid&w=740" alt="" className='max-w-xl w-full' />
        </div>
      </div>
      <div>
